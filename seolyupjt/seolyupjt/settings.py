"""
Django settings for seolyupjt project.
...
SECRET_KEY = 'z!q20*0cko)&ft35=)vga^kr!k@wd_)en0lso%0_@b+a2@hu^r'
...
WSGI_APPLICATION = 'seolyupjt.wsgi.application'
