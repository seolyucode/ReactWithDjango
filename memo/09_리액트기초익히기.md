...
* Prettier : code formatter => "editor.formatOnSave": true 설정 추천(파일 - 기본 설정 - 설정 - formatonsave 체크)
...
const tom2 = {
    ...
    "age": 10,
    "region": "Seoul",
    ["score" + "1"]: 100,  // Array 아님
};

console.log(tom2);  // { name: 'Tom', age: 10, region: 'Seoul', score1: 100 }
```
